    ...
    DarkGradientBackground {
        Column(
            ...
            AuthCard {
                ...
                TopScoreTextField(password, { password = it }, "Set password", visualTransformation = PasswordVisualTransformation())
                TopScoreTextField(confirmPassword, { confirmPassword = it }, "Confirm password", visualTransformation = PasswordVisualTransformation())
